...
public class DemoServlet extends HttpServlet {
    ...
    throws ServletException, IOException {
        ...
        try
        {
            ...
            String sql = "SELECT * FROM user where usuario='" + username + "' and password= '" + pwd + "'";
