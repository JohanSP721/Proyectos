...
nombreEstudiante = input( 'Ingrese el/los nombres del estudiante: ' );
apellidoEstudiante = input( 'Ingrese el/los apellidos del estudiante: ' );
edadEstudiante = int( input( 'Digite la edad del estudiante: ' ) );
numeroSalariosMinimos = float( input( 'Digite el numero de salarios minimos de ingreso familiar que recibe mensualmente el estudiante: ' ) );
puntajePrueba = int( input( 'Digite el puntaje que el estudiante obtuvo en la prueba: ' ) );
...
if ( numeroSalariosMinimos <= 0 ):
	print( 'El numero de salarios minimos no puede ser 0 ni negativo' );
	exit(1);
...
print(f"""
El estudiante {nombreEstudiante} {apellidoEstudiante} recibió:

un descuento por edad de: {descuentoEdad}%
un descuento por ingreso familiar de: {descuentoSalarios}%
un descuento por resultado de prueba de: {descuentoPrueba}%

lo que produce un descuento total de: {descuentoTotal}%
""");